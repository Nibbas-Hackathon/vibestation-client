  ...
  return (
    <section className="relative w-full flex justify-center items-center">
      <div className="flex  md:flex-col mb-[100px] md:flex-1 relative p-2 justify-center items-center">
        <div className="w-full h-screen gap-2 overflow-y-scroll md:flex-col justify-center items-center  rounded-md p-4 text-white backdrop-blur-2xl bg-white/10 border border-slate-500/50" style="
    padding-top: 3rem;
    padding-bottom: 3rem;
">
